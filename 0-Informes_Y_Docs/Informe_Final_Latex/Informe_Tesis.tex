...
\hline
Login & Logueo de usuarios previamente creados en la Sección de Administración & /login/ & Imagen \ref{fig:impl_web_1}  \\
\hline
...
Algo a tener en cuenta es que el usuario, una vez logueado (mediante /login/), podrá acceder a todas las demás secciones, las cuales son accesibles mediante los botones ubicados en la barra de navegación superior.
