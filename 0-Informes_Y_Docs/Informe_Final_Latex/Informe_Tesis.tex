...
Una vez que el reclutador dentro de la sección observada en la figura \ref{fig:Vista_Reclutador} haga click en "Analizar", el sistema reflejará el pipeline indicado en la figura \ref{fig:Pipeline_Final} para obtener como resultado final un TOP de los 'N' mejores candidatos para el puesto consultado (siempre y cuando los candidatos hayan aplicado a dicho puesto). 
